<template>
    <div class="sm:p-7 p-4">
        ...
        <table class="w-full text-left">
            ...
            <tbody class="text-gray-600 dark:text-gray-100">
                <tr>
                    ...
                    <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 text-red-500">- $120.00
                    </td>
                    <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800">
                        <div class="flex items-center">
                ...
                <tr>
                    ...
                    <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 text-red-500">- $49.99
                    </td>
                    <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800">
                        <div class="flex items-center">
                            <div class="sm:flex hidden flex-col">
                ...
                <tr>
                    ...
                    <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 md:table-cell hidden">
                        PlayStation 5</td>
                    <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 text-red-500">- $399.99
                    </td>
                    <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800">
                        <div class="flex items-center">
                            <div class="sm:flex hidden flex-col">
        ...
        <div class="mt-20 bg-blue-200 p-20">
            a
        </div>
